...
task3 = DockerOperator(
    ...
    command='/usr/spark/bin/spark-submit --master local[*] --packages org.apache.spark:spark-streaming-kafka-0-10_2.11:2.4.1,org.apache.spark:spark-sql-kafka-0-10_2.11:2.4.1 /usr/local/airflow/dags/src/spark_consume_data/pyspark_consumer.py {{ params.checkpoint_trans_path }} {{ params.checkpoint_loc_path }} {{ params.CLIENT }} {{ params.TOPICS }}',
